import { Universe, Cell, init_panic_hook } from "/assets/js/wasm_game_of_life_bg.wasm";
import { memory } from "/assets/js/wasm_game_of_life_bg.js";
import { Game_of_life_fps } from "/assets/js/game_of_life_fps.js";

init_panic_hook();

const frame = new Game_of_life_fps();
const CELL_SIZE = 5;
