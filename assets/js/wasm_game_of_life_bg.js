import * as wasm from '/assets/js/wasm_game_of_life_bg.wasm';
...
export class Universe {
    ...
    */
    glider_on(row, col) {
        wasm.universe_glider_on(this.ptr, row, col);
    }
    /**
    * @param {number} row
    * @param {number} col
    */
    pulsar_on(row, col) {
        wasm.universe_pulsar_on(this.ptr, row, col);
    }
    /**
    */
    reset_cells() {
    ...
    */
    random_cells(modular1, modular2) {
        wasm.universe_random_cells(this.ptr, modular1, modular2);
    }
    /**
    */
    tick() {
...
export const __wbg_time_8783b2299ea2501c = function(arg0, arg1) {
    console.time(getStringFromWasm0(arg0, arg1));
};

export const __wbg_timeEnd_9626e37ac688529f = function(arg0, arg1) {
